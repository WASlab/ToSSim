"""
Multi-GPU SFT training entry point for 🤗 Transformers / PEFT

Features
========
* Multi-GPU training with FSDP and DeepSpeed ZeRO support
...
Usage:
======
accelerate launch --config_file fsdp_config.yaml sft_multi_gpu.py train.json
"""
...
def load_model_and_tokenizer(cfg: Dict[str, Any]):
    ...
    # Multi-GPU - use device_map="auto" for automatic distribution
...
def main(cfg_path: str = "train.json"):
    ...
    # ── Multi-GPU TrainingArguments / SFTConfig ──
